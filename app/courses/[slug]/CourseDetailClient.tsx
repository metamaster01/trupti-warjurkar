...
// export default function CourseDetailPageClient({ id }: {  id: string } ) {

//   useEffect(() => {
//     console.log("received id prop:", id)
//   }, [id])

//   const courseId = Number(id) // safe conversion
//   if (Number.isNaN(courseId)) {
//     return (
//       <main className="min-h-screen flex items-center justify-center">
//         <div>Invalid course id: {String(id)}</div>
//       </main>
//     )
//   }
...
import { Check, Play, Users, FileText, Award } from "lucide-react"
import RazorpayButton from "@/components/razorpay-button"
import type { CourseDetail } from "@/lib/courses-data"
